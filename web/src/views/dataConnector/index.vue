<template>
  <div>
    <div class="n-layout-page-header">
      <n-card :bordered="false" title="数据源" />
    </div>
      ...
      >
        <template #tableTitle>
          <n-button
            ...
            v-if="hasPermission(['/dataConnector/edit'])"
          >
            <template #icon>
              <n-icon>
                <PlusOutlined />
          ...
          <n-button
            ...
            class="min-left-space"
            v-if="hasPermission(['/dataConnector/delete'])"
          >
            <template #icon>
              <n-icon>
                <DeleteOutlined />
...
<script lang="ts" setup>
  ...
  import { List, Delete, Status } from '@/api/dataConnector';
