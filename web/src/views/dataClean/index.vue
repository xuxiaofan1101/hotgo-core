<template>
  <div>
    <div class="n-layout-page-header">
      <n-card :bordered="false" title="数据清洗" />
    </div>
      ...
      >
        <template #tableTitle>
          <n-button
            ...
            v-if="hasPermission(['/dataClean/edit'])"
          >
            <template #icon>
              <n-icon>
                <PlusOutlined />
          ...
          <n-button
            ...
            class="min-left-space"
            v-if="hasPermission(['/dataClean/delete'])"
          >
            <template #icon>
              <n-icon>
                <DeleteOutlined />
...
<script lang="ts" setup>
  ...
  import { List, Delete, Status } from '@/api/dataClean';
  ...
  function handleDelete(record: Recordable) {
    dialog.warning({
      title: '警告',
      content: `确定要删除数据清洗任务"${record.name}"吗？`,
      positiveText: '确定',
      negativeText: '取消',
      onPositiveClick: () => {
