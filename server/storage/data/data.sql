...
INSERT INTO `hg_sys_dict_type` (`id`, `pid`, `name`, `type`, `sort`, `remark`, `status`, `created_at`, `updated_at`) VALUES (NULL, 0, '数据集成枚举', 'data_integration', 70, '数据集成相关枚举', 1, @now, @now) ON DUPLICATE KEY UPDATE `id` = LAST_INSERT_ID(`id`), `name` = VALUES(`name`), `sort` = VALUES(`sort`), `remark` = VALUES(`remark`), `status` = VALUES(`status`), `updated_at` = @now;
SET @dataIntegrationDictPid := LAST_INSERT_ID();
INSERT INTO `hg_sys_dict_type` (`id`, `pid`, `name`, `type`, `sort`, `remark`, `status`, `created_at`, `updated_at`) VALUES (NULL, @dataIntegrationDictPid, '输入数据源类型', 'DataConnectorSourceTypeOptions', 10, '输入数据源类型选项', 1, @now, @now),(NULL, @dataIntegrationDictPid, '输出数据源类型', 'DataConnectorSinkTypeOptions', 20, '输出数据源类型选项', 1, @now, @now),(NULL, @dataIntegrationDictPid, 'Kafka认证模式', 'DataKafkaAuthModeOptions', 30, 'Kafka认证模式选项', 1, @now, @now),(NULL, @dataIntegrationDictPid, 'S3凭证模式', 'DataS3CredentialModeOptions', 40, 'S3凭证模式选项', 1, @now, @now),(NULL, @dataIntegrationDictPid, '日志级别', 'DataLogLevelOptions', 50, '日志级别选项', 1, @now, @now),(NULL, @dataIntegrationDictPid, 'Kafka起始位置', 'DataKafkaStartModeOptions', 60, 'Kafka起始位置选项', 1, @now, @now),(NULL, @dataIntegrationDictPid, '采样模式', 'DataSampleModeOptions', 70, '采样模式选项', 1, @now, @now),(NULL, @dataIntegrationDictPid, '数据格式', 'DataPayloadFormatOptions', 80, '数据格式选项', 1, @now, @now),(NULL, @dataIntegrationDictPid, '下游分发模式', 'DataSinkModeOptions', 90, '下游分发模式选项', 1, @now, @now),(NULL, @dataIntegrationDictPid, '下游分发失败策略', 'DataSinkFailurePolicyOptions', 100, '下游分发失败策略选项', 1, @now, @now) ON DUPLICATE KEY UPDATE `pid` = VALUES(`pid`), `name` = VALUES(`name`), `sort` = VALUES(`sort`), `remark` = VALUES(`remark`), `status` = VALUES(`status`), `updated_at` = @now;
...
INSERT INTO `hg_sys_dict_data` (`id`, `label`, `value`, `value_type`, `type`, `list_class`, `is_default`, `sort`, `remark`, `status`, `created_at`, `updated_at`) VALUES (NULL, 'HTTP', 'http', 'string', 'DataConnectorSourceTypeOptions', 'info', 1, 10, '输入数据源类型：HTTP', 1, @now, @now),(NULL, 'Kafka', 'kafka', 'string', 'DataConnectorSourceTypeOptions', 'primary', 1, 20, '输入数据源类型：Kafka', 1, @now, @now),(NULL, 'S3', 's3', 'string', 'DataConnectorSourceTypeOptions', 'warning', 1, 30, '输入数据源类型：S3', 1, @now, @now),(NULL, '日志', 'log', 'string', 'DataConnectorSourceTypeOptions', 'default', 1, 40, '输入数据源类型：日志', 1, @now, @now),(NULL, '手动', 'manual', 'string', 'DataConnectorSourceTypeOptions', 'default', 1, 50, '输入数据源类型：手动', 1, @now, @now),(NULL, 'HTTP Webhook', 'http', 'string', 'DataConnectorSinkTypeOptions', 'info', 1, 10, '输出数据源类型：HTTP Webhook', 1, @now, @now),(NULL, 'Kafka', 'kafka', 'string', 'DataConnectorSinkTypeOptions', 'primary', 1, 20, '输出数据源类型：Kafka', 1, @now, @now),(NULL, 'Feishu/Lark 飞书群机器人', 'feishu', 'string', 'DataConnectorSinkTypeOptions', 'default', 1, 30, '输出数据源类型：飞书群机器人', 1, @now, @now),(NULL, 'Lark', 'lark', 'string', 'DataConnectorSinkTypeOptions', 'default', 1, 40, '输出数据源类型：Lark', 1, @now, @now),(NULL, 'S3', 's3', 'string', 'DataConnectorSinkTypeOptions', 'warning', 1, 50, '输出数据源类型：S3', 1, @now, @now),(NULL, 'Elasticsearch', 'elasticsearch', 'string', 'DataConnectorSinkTypeOptions', 'default', 1, 60, '输出数据源类型：Elasticsearch', 1, @now, @now),(NULL, 'OpenSearch', 'opensearch', 'string', 'DataConnectorSinkTypeOptions', 'default', 1, 70, '输出数据源类型：OpenSearch', 1, @now, @now),(NULL, 'Splunk HEC', 'splunk', 'string', 'DataConnectorSinkTypeOptions', 'default', 1, 80, '输出数据源类型：Splunk HEC', 1, @now, @now),(NULL, '日志', 'log', 'string', 'DataConnectorSinkTypeOptions', 'default', 1, 90, '输出数据源类型：日志', 1, @now, @now),(NULL, '无认证', 'none', 'string', 'DataKafkaAuthModeOptions', 'default', 1, 10, 'Kafka认证模式：无认证', 1, @now, @now),(NULL, 'SASL/PLAIN', 'plain', 'string', 'DataKafkaAuthModeOptions', 'primary', 1, 20, 'Kafka认证模式：SASL/PLAIN', 1, @now, @now),(NULL, 'SCRAM-SHA-256', 'scram-sha-256', 'string', 'DataKafkaAuthModeOptions', 'warning', 1, 30, 'Kafka认证模式：SCRAM-SHA-256', 1, @now, @now),(NULL, 'SCRAM-SHA-512', 'scram-sha-512', 'string', 'DataKafkaAuthModeOptions', 'warning', 1, 40, 'Kafka认证模式：SCRAM-SHA-512', 1, @now, @now),(NULL, 'OAuth Bearer', 'oauthbearer', 'string', 'DataKafkaAuthModeOptions', 'info', 1, 50, 'Kafka认证模式：OAuth Bearer', 1, @now, @now),(NULL, '云角色', 'role', 'string', 'DataS3CredentialModeOptions', 'primary', 1, 10, 'S3凭证模式：云角色', 1, @now, @now),(NULL, '静态 AK/SK', 'static', 'string', 'DataS3CredentialModeOptions', 'warning', 1, 20, 'S3凭证模式：静态 AK/SK', 1, @now, @now),(NULL, '匿名访问', 'anonymous', 'string', 'DataS3CredentialModeOptions', 'default', 1, 30, 'S3凭证模式：匿名访问', 1, @now, @now),(NULL, 'debug', 'debug', 'string', 'DataLogLevelOptions', 'default', 1, 10, '日志级别：debug', 1, @now, @now),(NULL, 'info', 'info', 'string', 'DataLogLevelOptions', 'info', 1, 20, '日志级别：info', 1, @now, @now),(NULL, 'warning', 'warning', 'string', 'DataLogLevelOptions', 'warning', 1, 30, '日志级别：warning', 1, @now, @now),(NULL, 'error', 'error', 'string', 'DataLogLevelOptions', 'error', 1, 40, '日志级别：error', 1, @now, @now),(NULL, '从最新位置开始', 'latest', 'string', 'DataKafkaStartModeOptions', 'primary', 1, 10, 'Kafka起始位置：最新', 1, @now, @now),(NULL, '从最早位置开始', 'earliest', 'string', 'DataKafkaStartModeOptions', 'info', 1, 20, 'Kafka起始位置：最早', 1, @now, @now),(NULL, '指定 Offset', 'offset', 'string', 'DataKafkaStartModeOptions', 'warning', 1, 30, 'Kafka起始位置：指定 Offset', 1, @now, @now),(NULL, '最新数据', 'latest', 'string', 'DataSampleModeOptions', 'primary', 1, 10, '采样模式：最新数据', 1, @now, @now),(NULL, '最早数据', 'earliest', 'string', 'DataSampleModeOptions', 'info', 1, 20, '采样模式：最早数据', 1, @now, @now),(NULL, '随机采样', 'random', 'string', 'DataSampleModeOptions', 'warning', 1, 30, '采样模式：随机采样', 1, @now, @now),(NULL, 'JSON', 'json', 'string', 'DataPayloadFormatOptions', 'primary', 1, 10, '数据格式：JSON', 1, @now, @now),(NULL, 'JSON Lines', 'json_lines', 'string', 'DataPayloadFormatOptions', 'info', 1, 20, '数据格式：JSON Lines', 1, @now, @now),(NULL, '文本', 'text', 'string', 'DataPayloadFormatOptions', 'default', 1, 30, '数据格式：文本', 1, @now, @now),(NULL, '并行分发', 'parallel', 'string', 'DataSinkModeOptions', 'primary', 1, 10, '下游分发模式：并行', 1, @now, @now),(NULL, '顺序分发', 'serial', 'string', 'DataSinkModeOptions', 'info', 1, 20, '下游分发模式：顺序', 1, @now, @now),(NULL, '继续分发', 'continue', 'string', 'DataSinkFailurePolicyOptions', 'warning', 1, 10, '下游分发失败策略：继续分发', 1, @now, @now),(NULL, '停止分发', 'stop', 'string', 'DataSinkFailurePolicyOptions', 'error', 1, 20, '下游分发失败策略：停止分发', 1, @now, @now);
